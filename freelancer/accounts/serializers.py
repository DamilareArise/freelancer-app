...
class UserSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = User
        fields = ['id', 'first_name', 'last_name', 'email', 'phone','passport', 'is_verified', 'document_status', 'oib', 'vat', 'document_type', 'document_front', 'document_back', 'certicate', 'selfie', 'business_reg', 'auth_letter', 'status', 'created_at']
...
class DocumentSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = User
        fields = ['oib', 'vat', 'document_type', 'document_front', 'document_back', 'certicate', 'selfie', 'business_reg', 'auth_letter', 'auth_letter', 'role']
